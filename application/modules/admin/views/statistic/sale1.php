	...
	<div id="container" class="">
		...
		<div class="container_wr">
			...
			<div class="local_sch03 local_sch">
				<div>
					<form name="frm_sale_today" action="<?=base_url('/admin/statistic')?>/sale1today" method="get">
						<strong>일일 매출</strong>
				...
				<div>
					<form name="frm_sale_date" action="<?=base_url('/admin/statistic')?>/sale1date" method="get">
						<strong>일간 매출</strong>
				...
				<div>
					<form name="frm_sale_month" action="<?=base_url('/admin/statistic')?>/sale1month" method="get">
						<strong>월간 매출</strong>
				...
				<div class="sch_last">
					<form name="frm_sale_year" action="<?=base_url('/admin/statistic')?>/sale1year" method="get">
						<strong>연간 매출</strong>

...
<head>
	...
	<link rel="stylesheet" href="<?=base_url('/include/admin/css')?>/summernote-lite.css">
	<script src="<?=base_url('/include/admin/js')?>/jquery-3.3.1.min.js"></script>
	<script src="<?=base_url('/include/admin/js')?>/admin.js"></script>
	<script src="<?=base_url('/include/admin/js')?>/jquery.menu.js"></script>
	<script src="<?=base_url('/include/admin/js')?>/summernote-lite.js"></script>
	<script src="<?=base_url('/include/admin/js')?>/Chart.js"></script>
...
<body>
	...
	<header id="hd">
		...
		<div id="hd_top">
			...
			<div id="logo"><a href="<?=base_url('/admin')?>"><img img src="<?=base_url('/images/admin')?>/logo.png" alt="관리자"></a></div>
			<div id="tnb">
				<ul>
				...
				<li class="gnb_li <? if ($sub_menu=='100') echo "on\""; ?>">
					...
					<div class="gnb_oparea_wr">
						<div class="gnb_oparea">
							<h3>환경설정</h3>
							<ul>
								<li data-menu="100100"><a href="<?=base_url('/admin/setting')?>/configform" class="gnb_2da  ">기본환경설정</a></li>
								<li data-menu="100280"><a href="<?=base_url('/admin/setting')?>/theme" class="gnb_2da gnb_grp_style gnb_grp_div">테마설정</a></li>
								<li data-menu="100290"><a href="<?=base_url('/admin/setting')?>/menulist" class="gnb_2da gnb_grp_style">메뉴설정</a>
								<li data-menu="100290"><a href="<?=base_url('/admin/setting')?>/player" class="gnb_2da gnb_grp_style">플레이어설정</a><!-- 추가 되어야 할 메뉴-->
								</li>
							</ul>
						</div>
					</div>
				...
				<li class="gnb_li <? if ($sub_menu=='200') echo "on\""; ?>">
					...
					<div class="gnb_oparea_wr">
						<div class="gnb_oparea">
							<h3>회원관리</h3>
							<ul>
								<li data-menu="200100"><a href="<?=base_url('/admin/member')?>/memberlist" class="gnb_2da">회원관리</a></li>
								<li data-menu="200300"><a href="<?=base_url('/admin/member')?>/maillist" class="gnb_2da  ">회원메일발송</a></li>
								<li data-menu="200200"><a href="<?=base_url('/admin/member')?>/pointlist" class="gnb_2da  gnb_grp_div">포인트관리</a>
							</ul>
						</div>
					</div>
				</li>
				<li class="gnb_li <? if ($sub_menu=='300') echo "on\""; ?>">
					...
					<div class="gnb_oparea_wr">
						<div class="gnb_oparea">
							<h3>게시판관리</h3>
							<ul>
								<li data-menu="300100"><a href="<?=base_url('/admin/board')?>/boardlist" class="gnb_2da  ">게시판관리</a></li>
								<li data-menu="300600"><a href="<?=base_url('/admin/board')?>/contentlist" class="gnb_2da gnb_grp_style gnb_grp_div">내용관리</a></li>
							</ul>
						</div>
					</div>
				</li>
					...
					<div class="gnb_oparea_wr">
						<div class="gnb_oparea">
							...
							<ul>
								...
								<li data-menu="400660"><a href="<?=base_url('/admin/goods')?>/teacherlist" class="gnb_2da  ">강사관리</a></li>
								...
								<li data-menu="400410"><a href="<?=base_url('/admin/goods')?>/inorderlist" class="gnb_2da gnb_grp_style ">미완료주문</a></li>
							</ul>
						</div>
					</div>
				</li>
				<li class="gnb_li <? if ($sub_menu=='500') echo "on\""; ?>">
					...
					<div class="gnb_oparea_wr">
						<div class="gnb_oparea">
							<h3>상품현황/기타</h3>
							<ul>
								<li data-menu="500110"><a href="<?=base_url('/admin/statistic')?>/sale1" class="gnb_2da  ">매출현황</a></li>
								<li data-menu="500120"><a href="<?=base_url('/admin/statistic')?>/orderprint" class="gnb_2da gnb_grp_style gnb_grp_div">주문내역출력</a></li>
								<li data-menu="500500"><a href="<?=base_url('/admin/statistic')?>/bannerlist" class="gnb_2da gnb_grp_style gnb_grp_div">배너관리</a></li>
							</ul>
						</div>
					</div>
				</li>

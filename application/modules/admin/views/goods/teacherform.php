<div id="wrapper">
	<div id="container" class="">
		<h1 id="container_title">강사 수정</h1>
		<div class="container_wr">
			<form name="fmember" id="fmember" method="post" enctype="multipart/form-data">
					...
					<table>
						...
						<tbody>
							...
							<tr>
								...
								<td><a href="<?=base_url('/admin/member')?>/pointlist?sfl=mb_id&amp;stx=admin" target="_blank">710</a> 점</td>
							</tr>
							<tr>
							...
							<tr>
								<th scope="row"><label for="mb_memo">강사소개</label></th>
				...
				<div class="btn_fixed_top">
					<a href="<?=base_url('/admin/goods')?>/teacherlist?sst=&amp;sod=&amp;sfl=&amp;stx=&amp;page=0" class="btn btn_02">목록</a>

					...
					<table>
						...
						<tbody>
							<tr class="bg0">
								...
								<td class="td_mng td_mng_s"><a href="<?=base_url('/admin/goods')?>/itemform?w=u&amp;it_id=1387869984&amp;ca_id=&amp;sel_ca_id=&amp;sel_field=b.it_name&amp;search=&amp;sort1=a.io_stock_qty&amp;sort2=desc&amp;page=1" class="btn btn_03">수정</a></td>
							</tr>
						</tbody>
					</table>
				</div>
				<div class="btn_fixed_top">
					<a href="<?=base_url('/admin/goods')?>/itemstocklist" class="btn btn_02">상품재고관리</a>

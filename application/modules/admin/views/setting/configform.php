...
<div id="wrapper">
	<div id="container" >
		<h1 id="container_title">기본환경설정</h1>
		<div class="container_wr">
			<?php echo form_open('admin/setting/configform_process','name="frm" id="frm" novalidate="novalidate"'); ?>
				<input type="hidden" name="token" value="">
				<section id="anc_scf_info">
					<h2 class="h2_frm">사이트 정보</h2>
					...
					<div class="tbl_frm01 tbl_wrap">
						<table>
							...
							<tbody>
								<tr>
									<th scope="row"><label for="market_name">사이트명</label></th>
									<td>
										<input type="hidden" name="market_id" value="123456" />
										<input type="text" name="market_name" value="<?=$config_list->market_name?>" id="market_name" class="frm_input" size="60" />
									</td>
									<th scope="row"><label for="market_title">사이트 제목</label></th>
									<td>
										<input type="text" name="market_title" value="<?=$config_list->market_title?>" id="market_title" class="frm_input" size="60" />
									</td>
								</tr>
								<tr>
									...
									<td colspan="3">
										...
										<textarea id="summernote" name="editordata2"></textarea>
						...
						<table>
							...
							<tbody>
								<tr>
									...
									<td>
										<input type="text" name="company_name" value="<?=$config_list->cpname?>" id="company_name" class="frm_input" size="30" />
									</td>
									<th scope="row"><label for="license_no">사업자등록번호</label></th>
									<td>
										<input type="text" name="license_no" value="<?=$config_list->license_no?>" id="license_no" class="frm_input" size="30" />
									</td>
								</tr>
								<tr>
									<th scope="row"><label for="delegate_name">대표자명</label></th>
									<td colspan="3">
										<input type="text" name="delegate_name" value="<?=$config_list->delegate_name?>" id="delegate_name" class="frm_input" size="30" />
									</td>
								</tr>
								<tr>
									<th scope="row"><label for="company_tel">대표전화번호</label></th>
									<td>
										<input type="text" name="company_tel" value="<?=$config_list->cptel?>" id="company_tel" class="frm_input" size="30" />
									</td>
									<th scope="row"><label for="company_fax">팩스번호</label></th>
									<td>
										<input type="text" name="company_fax" value="<?=$config_list->cpfax?>" id="company_fax" class="frm_input" size="30" />
									</td>
								</tr>
								<tr>
									<th scope="row"><label for="business_no">통신판매업 신고번호</label></th>
									<td>
										<input type="text" name="business_no" value="<?=$config_list->business_no?>" id="business_no" class="frm_input" size="30" />
									</td>
									<th scope="row"><label for="buga_no">부가통신 사업자번호</label></th>
									<td>
										<input type="text" name="buga_no" value="" id="buga_no" class="frm_input" size="30" />
									</td>
								</tr>
								<tr>
									<th scope="row"><label for="company_zip">사업장우편번호</label></th>
									<td>
										<input type="text" name="company_zip" value="<?=$config_list->zipcd?>" id="company_zip" class="frm_input" size="10" />
									</td>
									<th scope="row"><label for="address">사업장주소</label></th>
									<td>
										<input type="text" name="address" value="<?=$config_list->address?>" id="address" class="frm_input" size="30" />
									</td>
								</tr>
								<tr>
									<th scope="row"><label for="piname">정보관리책임자명</label></th>
									<td>
										<input type="text" name="piname" value="<?=$config_list->piname?>" id="piname" class="frm_input" size="30" />
									</td>
									<th scope="row"><label for="piemail">정보책임자 e-mail</label></th>
									<td>
										<input type="text" name="piemail" value="<?=$config_list->piemail?>" id="piemail" class="frm_input" size="30" />
									</td>
								</tr>
							</tbody>
						</table>
								...
								<tr>
									...
									<td>
										...
										<div class="scf_cardtest kcp_cardtest">
											...
											<button type="button" class="scf_cardtest_btn btn_frmline">테스트결제 팁 더보기</button>
										</div>
						...
						<table>
							...
							<tbody>
								<tr>
									...
									<td>
										<span class="frm_info">이용 중이거나 이용하실 배송업체를 선택하세요.</span>
								...
								<tr>
									...
									<td>
										<span class="frm_info"><strong>금액별차등</strong>으로 설정한 경우, 주문총액이 배송비상한가 미만일 경우 배송비를 받습니다.<br><strong>무료배송</strong>으로 설정한 경우, 배송비상한가 및 배송비를 무시하며 착불의 경우도 무료배송으로 설정합니다.<br><strong>상품별로 배송비 설정을 한 경우 상품별 배송비 설정이 우선</strong> 적용됩니다.<br>예를 들어 무료배송으로 설정했을 때 특정 상품에 배송비가 설정되어 있으면 주문시 배송비가 부과됩니다.</span>
								...
								<tr>
									...
									<td>
										<span class="frm_info">'예'로 설정한 경우 주문서에서 희망배송일을 입력 받습니다.</span>

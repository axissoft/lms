		...
		<div class="container_wr">
			...
			<form name="fmenulist" id="fmenulist" method="post">
					...
					<table>
						...
						<tbody>
							<tr class="bg0 menu_list menu_group_10">
								...
								<td class="td_mng">
									<button type="button" class="btn_add_submenu btn_03" onclick="window.open('<?=base_url('/admin/setting')?>/menuform')">추가</button>
				...
				<div class="btn_fixed_top">
					<button type="button" class="btn btn_02" onclick="window.open('<?=base_url('/admin/setting')?>/menuform')">메뉴추가<span class="sound_only"> 새창</span></button>

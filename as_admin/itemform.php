						...
						<table>
							...
							<tbody>
								...
								<tr>
									...
									<td colspan="2">
										<span class="frm_info">상품명 하단에 상품에 대한 추가적인 설명이 필요한 경우에 입력합니다. HTML 입력도 가능합니다.</span>                <input type="text" name="it_basic" value="" id="it_basic" class="frm_input" size="95">
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td>
										<span class="frm_info">메인화면에 유형별로 출력할때 사용합니다.<br>이곳에 체크하게되면 상품리스트에서 유형별로 정렬할때 체크된 상품이 가장 먼저 출력됩니다.</span>                <input type="checkbox" name="it_type1" value="1" id="it_type1">
								...
								<tr>
									...
									<td>
										<span class="frm_info">입력하지 않으면 상품상세페이지에 출력하지 않습니다.</span>                <input type="text" name="it_origin" value="" id="it_origin" class="frm_input" size="40">
									</td>
									<td class="td_grpset">&nbsp;</td>
								</tr>
								<tr>
									...
									<tr>
										...
										<td colspan="2">
											<div id="sit_supply_frm" class="sit_option tbl_frm01">
												<span class="frm_info">옵션항목은 콤마(,) 로 구분하여 여러개를 입력할 수 있습니다. 스마트폰을 예로 들어 [추가1 : 추가구성상품 , 추가1 항목 : 액정보호필름,케이스,충전기]<br><strong>옵션명과 옵션항목에 따옴표(', ")는 입력할 수 없습니다.</strong></span>                    <table>

					...
					<table>
						...
						<tbody>
							<tr class="bg0">
								...
								<td class="td_left"><a href="./mail_form.php?w=u&amp;ma_id=123">test</a></td>
								<td class="td_datetime">2018-07-23 14:48:45</td>
								<td class="td_test"><a href="#">테스트</a></td>
								<td class="td_send"><a href="./mail_select_form.php?ma_id=123">보내기</a></td>
								<td class="td_mng"><a href="./mail_preview.php?ma_id=123" target="_blank" class="btn btn_03">미리보기</a></td>
							</tr>
						</tbody>
					</table>
				</div>
